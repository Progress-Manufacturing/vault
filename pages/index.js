...
class Home extends Component {
  ...
  // async getUser() {
  //   const authToken = await this.auth.acquireUserTokenSilent()
  //   const userInfo = await getUserDetails(authToken)
  ...
  render() {
    // const { manager, user} = this.getUser();
    return (
      <ApolloConsumer>
        {client => (
          <Main>
            {/* {console.log({manager})}
            {console.log({user})} */}
            <Card title={`Welcome - You`} highlight={true}>
