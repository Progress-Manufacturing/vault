...
import { getUserAvatar } from "../auth/msal-graph"

import { Box, Image, Stack, Text, Button, DropButton } from "grommet"
import { Menu as MenuIcon, Notification } from "grommet-icons"
...
class TopBar extends Component {
    ...
    componentDidMount() {
        this.getAvatar().then(async (res) => {
            const avatar = await this.setAvatar(res.avatar)
            this.setState({
                avatar: avatar
            })
        }).catch((err) => {
    ...
    async getAvatar() {
        ...
        try {
            ...
            const avatar = await getUserAvatar(token)
