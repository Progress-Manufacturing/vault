        ...
        <ResponsiveContext.Consumer>
          {size => (
            ...
            > 
              {(!showSidebar || size !== "small") ? (
                <Box gridArea="appbar" background="lightBlack">
                  <Collapsible direction="horizontal" open={showSidebar}>
                    <AppBar admin={this.props.admin} menu={ ciMenu === true ? CiMenu.CiMenu : VaultMenu.VaultMenu} />
                  </Collapsible>
                </Box>
              ) : (
                <Layer
              ...
              <TopBar area="header" avatar={this.props.avatar} handleClick={this.handleClick} />
              <Box 
                  gridArea="main"
