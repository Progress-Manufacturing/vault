                ...
                {(!showSidebar || size !== "small") ? (
                  <Box gridArea="appbar" background="lightBlack">
                    <Collapsible direction="horizontal" open={showSidebar}>
                      <AppBar admin={this.state.admin} supervisor={this.props.supervisor} lead={this.props.lead} menu={ (router.pathname).includes("ci") ? CiMenu.CiMenu : VaultMenu.VaultMenu} />
                    </Collapsible>
                  </Box>
                ) : (
                  <Layer
                ...
                <Box 
                  ...
                  > 
                    ...
                    <Box
                      ...
                      pad={{ vertical: "15px", horizontal: "50px" }}
