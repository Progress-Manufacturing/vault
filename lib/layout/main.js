...
import { getUserDetails, getUserSupervisor, getUserAvatar } from '../auth/msal-graph'
...
class Main extends Component {
  ...
  getUserData = async () => {
    ...
    try {
      ...
      // const tempAvatar = await getUserAvatar(token);
      // const avatar = await this.setAvatar(tempAvatar.avatar);
  ...
  render() {
    const  { showSidebar, me, userSupervisor, avatar } = this.state
