...
const initialAdminNotification = (emails, submission) => {
    ...
    return (
        {
            subject: "Continual Improvement Program - New Submission",
            toRecipients: emailAddresses,
            body: {
                content: `<h1>Submission #${submission}</h1><br/>A Continual Improvement has been submitted please login and designate it for <b>Production</b> or <b>Office</b>.<br/> <a href='https://vault.progressmfg.com/ci/all-submissions/submission?id=${submission}' style='background: #D0011B; padding: 15px 30px; color: black, text-align: center'>All Submissions</a>`,
                contentType: "html"
            }
        }
    )
...
//
// --------------------------------
const supervisorReviewNotificationToUser = (email, submission) => (
    {
        ...
        body: {
            content: `<h1>Submission #${submission}</h1><br/>Your supervisor has reviewed your suggestion. Please login to view their response.<br/> <a href='https://vault.progressmfg.com/ci/my-submissions/submission?id=${submission}' style='background: #D0011B; padding: 15px 30px; color: black, text-align: center'>Your Submissions</a>`,
            contentType: "html",
        }
    }
)

const supervisorReviewNotificationToAdmin = (emails, submission) => {
    let emailAddresses = [];
...
export {
    ...
    supervisorReviewNotificationToUser,
    supervisorReviewNotificationToAdmin,
