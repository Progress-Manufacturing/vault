...
const GET_NEW_TEAM_SUBMISSIONS = gql`
    query fetchNewLeadSubmissions {
        submissions: fetchNewLeadSubmissions {
            id
            description
            createdAt
            progress {
...
const InProgressSubmissions = (props) => {
    ...
    return (
        <Query query={GET_NEW_TEAM_SUBMISSIONS} variables={{ userId }}>
            {({ loading, error, data }) => {
