...
const GET_IN_PROGRESS_SUPERVISOR_SUBMISSIONS = gql`
    query fetchInProgressSupervisorSubmissions {
        submissions: fetchInProgressSupervisorSubmissions {
            id
            description
            createdAt
            progress {
...
const InProgressSubmissions = (props) => {
    ...
    return (
        <Query query={GET_IN_PROGRESS_SUPERVISOR_SUBMISSIONS} variables={{ userId }}>
            {({ loading, error, data }) => {
