...
const GET_ACTIVE_SUPERVISOR_SUBMISSIONS = gql`
    query fetchActiveSupervisorSubmissions {
        submissions: fetchActiveSupervisorSubmissions {
            id
            description
            createdAt
            progress {
...
const ActiveSubmissions = (props) => {
    ...
    return (
        <Query query={GET_ACTIVE_SUPERVISOR_SUBMISSIONS} variables={{ userId }}>
            {({ loading, error, data }) => {
