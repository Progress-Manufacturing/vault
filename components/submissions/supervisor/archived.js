...
const GET_ARCHIVED_SUPERVISOR_SUBMISSIONS = gql`
    query fetchArchivedSupervisorSubmissions {
        submissions: fetchArchivedSupervisorSubmissions {
            id
            description
            createdAt
            progress {
...
const ArchivedSubmissions = (props) => {
    const userId = props.userId
    
    return (
        <Query query={GET_ARCHIVED_SUPERVISOR_SUBMISSIONS} variables={{ userId }}>
            {({ loading, error, data }) => {
