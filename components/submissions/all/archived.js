...
const GET_ALL_ARCHIVED_SUBMISSIONS = gql`
    query fetchCompletedAllSubmissions {
        submissions: fetchArchivedAllSubmissions {
            id
            description
            createdAt
            progress {
...
const ArchivedSubmissions = (props) => {
    ...
    return (
        <Query query={GET_ALL_ARCHIVED_SUBMISSIONS} variables={{ userId }}>
            {({ loading, error, data }) => {
